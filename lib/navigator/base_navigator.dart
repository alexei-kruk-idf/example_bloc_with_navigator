...
abstract class BaseNavigator {
  ...
  void init({
    ...
    Function(String screenName, {NavResult? result, bool includingLast})? popUntilByScreenName,
...
class NavigatorImpl implements BaseNavigator {
  ...
  @override
  void popUntil(BasePage page, {NavResult? result}) => _popUntil?.call(page, result ?? NavResult());

  @override
  void popAndPush(BasePage page, {NavResult? result}) => _popAndPush?.call(page, result: result);
